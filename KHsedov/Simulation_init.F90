...
#include "constants.h"
  ...
  real    :: vctr
  call RuntimeParameters_get('sim_rhoUp', sim_rhoUp)
  call RuntimeParameters_get('sim_rhoLo', sim_rhoLo)
  call RuntimeParameters_get('sim_tempUp', sim_tempUp)
  call RuntimeParameters_get('sim_tempLo', sim_tempLo)
  call RuntimeParameters_get('sim_isOriginalSedov', sim_isOriginalSedov) ! NEW
